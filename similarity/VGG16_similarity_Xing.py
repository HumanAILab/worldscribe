...
def get_frame_similarity(x,y):
	...
	image_similarity_cosine = calculate_similarity_cosine(get_feature_vector_fromPIL(x), get_feature_vector_fromPIL(y))

	return image_similarity_cosine
	# image_similarity_euclidean = calculate_similarity_euclidean(get_feature_vector_fromPIL(img_data_list[31]), get_feature_vector_fromPIL(img_data_list[11]))


# x = cv2.imread('/Users/rueichechang/Projects/crosscap/Image-Similarity-in-Percentage/images/boris1.jpg')
# x = cv2.resize(x, (224, 224))
# y = cv2.imread('/Users/rueichechang/Projects/crosscap/Image-Similarity-in-Percentage/images/boris2.jpg')
# y = cv2.resize(y, (224, 224))

# print(get_frame_similarity(x,y))

# x = load_img('/Users/rueichechang/Projects/crosscap/Image-Similarity-in-Percentage/images/boris1.jpg', target_size=(224, 224))
# x = img_to_array(x)
# y = load_img('/Users/rueichechang/Projects/crosscap/Image-Similarity-in-Percentage/images/boris1.jpg', target_size=(224, 224))
# y = img_to_array(y)
